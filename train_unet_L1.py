...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(dataset=train_set, num_workers=4, batch_size=84, shuffle=True)#batch_size改小，原来是64，12用了2.6g，可以考虑20
    ...
    for epoch in range(1, NUM_EPOCHS + 1):#遍历num_epoch次
        ...
        netG.eval()#创建文件夹SRF_
        out_path = 'training_results/SRF_reparam_ECB6ESA6_DIV2K_unet_L1_imgsize_128' + str(UPSCALE_FACTOR) + '/'
        ...
        if epoch % 20 == 0 and epoch != 0:#每20个epoch后将训练结果写入statistics/csv文件中
            ...
            data_frame.to_csv(out_path + 'srf_' + str(UPSCALE_FACTOR) + '_train_results_reparam_ECB6ESA6_epoch600_DIV2K_unet_L1_imgsize_128.csv', index_label='Epoch')
